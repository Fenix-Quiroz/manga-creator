    ...
    <div className="font-sans  h-screen  p-4   mx-auto lg:overflow-hidden">
      <section className="flex flex-col md:flex-row items-start lg:justify-around pb-4 lg:pb-0">
        <div className="flex flex-col items-start md:flex-row lg:items-center pb-3 lg:pb-0 gap-4 lg:gap-12 ">
          <Link
            className="text-xl bg-accent px-4 py-2 rounded-sm hover:text-purple-500"
            href="/"
          >
            Inicio
          </Link>
          <p className="text-2xl font-bold ">
            Generando un manga de{" "}
        ...
        <a
          className="text-xl  bg-accent px-4 py-2 rounded-sm mt-4 lg:mt-0 hover:text-purple-500"
          href="https://gemini.google.com/app?hl=es"
          target="_blanck"
        >
          Ir a GEMINI
        </a>
      ...
      <div className="flex flex-col h-screen">
        <Conversation>
          <ConversationContent className="max-w-xl mx-auto">
            {error && (
              <p className="text-red-500 text-2xl">Error al generar historia</p>
            )}
